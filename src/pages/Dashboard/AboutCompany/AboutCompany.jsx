...
import { getDashboardData,aboutCompany, getStateCityPincode, verifyPan } from '../../../Utils/api';
...
function AboutCompany() {
    ...
    const submit = () =>{
        ...
        const param = {
          ...
          emp_work_mode:formData.workingType,
    ...
    <br />
       <BoxWrapper  className="w100" >
        <div className="formmainBox flex">
          <div className="left">
            <div className='center gap4 pointer' onClick={()=>goBack(navigate,"/my-dashboard/upload-utilitybill")} >
